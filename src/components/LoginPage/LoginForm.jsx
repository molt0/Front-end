...
const PsInput = () => {
  ...
  return(
    <Box>
      ...
      <Center>
        <Box width="300px" height="1px" my="20px" bgColor="teal.300"/>
      </Center>
      
      <Box>
        <Input width="300px" height="40px" left="100px"placeholder="아이디" />
      </Box>
      ...
      <Center>
        <Login_btn>
          <Icon as={TriangleUpIcon} className="in_btn" mt="50px" width="200px" height="50px" color="teal.300"/>
        </Login_btn>
      </Center>
    </Box>
  );
